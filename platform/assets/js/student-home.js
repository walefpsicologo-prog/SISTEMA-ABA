...
async function boot(){
  try{
    ...
    }catch(err){console.warn('notifications_load_failed',err);q('#recentNotifications').innerHTML='<div class="empty-state">Notificações temporariamente indisponíveis.</div>'}
