...
function refineCurriculum(){
 ...
 <div class="curriculum-columns">
  ...
  <article class="curriculum-box"><span class="kicker">Responsabilidade técnica e formação</span><h3>Supervisão, equipe e ensino</h3><p>Experiência em <strong>responsabilidade técnica, supervisão e formação ABA</strong>, incluindo organização de rotinas clínicas, acompanhamento de profissionais, monitoramento de qualidade, padronização de registros e apoio à tomada de decisão baseada em dados.</p><p>Atuação em <strong>monitoria e instrutoria de formação profissional</strong>, com treino aplicado de procedimentos, orientação de equipes e desenvolvimento de competências para implementação de programas comportamentais.</p></article>
